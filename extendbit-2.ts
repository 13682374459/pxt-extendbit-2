/*
 * @file extendbit-2
 * @brief Laplus's extendbit makecode library.
...
namespace extendbit_2 {
	...
	*/
    ...
    /**
     *  Notice:Install the light sensor jump cap before use !
     */
    //% weight=50 blockGap=15
    //% blockId=light_Value block="light sensor value"
    export function lightValue():number {
      ...
      /**
     *  Notice:Install the Sound sensor jump cap before use !
     */
    //% weight=40 blockGap=15
    //% blockId=Sound_Value block="Sound sensor value"
    export function SoundValue():number {
